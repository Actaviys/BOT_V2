...
Команди для контактів:
 ...
 12 - "add-email [name] [Email]" -> Команда додавання електронної пошти до користувача
 13 - "show-email [name]" -> Виводить Email
        ...
        try: #Якщо є команда то виконую перевірки
            ...
            match command: #Команди
                ...
                case "birthdays": #??????????Виводжу дні народження користувачів на найближчий тиждень
                    ...
                    print("Dictionary with greetings for the week: ", book.find_birthday_users(in_period))
